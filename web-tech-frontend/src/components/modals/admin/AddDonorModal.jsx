    ...
    return (
        ...
        <div className="bg-white w-[520px] rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.15)] overflow-hidden">
            ...
            <button
                ...
                className="px-6 py-2 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[#FF6971] to-[#E0003C] hover:opacity-90 transition shadow-md"
            >
                Add Donor
            </button>
            </div>
    ...
    <div>
        ...
        <div className="mt-2 flex items-center gap-3 border border-gray-200 rounded-xl px-3 py-2.5 bg-white focus-within:ring-2 focus-within:ring-[#FF6971]/30 transition">
